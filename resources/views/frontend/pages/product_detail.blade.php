...
@endsection
@section('title','GH.PK || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat">Category :<a href="{{route('product-cat', !empty($product_detail->cat_info['slug']) ? $product_detail->cat_info['slug'] : '')}}">{{ !empty($product_detail->cat_info['title']) ? $product_detail->cat_info['title'] : 'Not Available' }}</a></p>
